...
// MARK: - TimelineFeedRequest
/// Request for fetching timeline feed data (horizontal carousel)
/// Endpoint: /api/v1/stores/{storeId}/carousel/{carouselId}
struct TimelineFeedAPIRequest: Request {
    ...
    var path: EndpointPath? {
        "/api/v1/stores/\(storeId)/carousel/\(carouselId)"
    }
